...
class DoctorSchedule extends Component {
        ...
        for(let i = 0; i < 7; i++){
         ...
         if(language === LANGUAGES.VI){
            if(i === 0){
                ...
                let label_Vi = moment(new Date()).add(i,'days').format('dddd - DD/MM');
                object.label = this.capitalizeFirstLetter(label_Vi);
            }
    ...
    render() {
        ...
        return (
            ...
            <span> <FormattedMessage id="patient.detaildoctor.choose"/>  <i className='far fa-hand-point-up'/> <FormattedMessage id="patient.detaildoctor.bookfree"/></span>
            </div>
            </>
            :<div className='no-schedule'>
            <FormattedMessage id="patient.detaildoctor.noschedule"/>
            </div>
            }
            </div>
            </div>
